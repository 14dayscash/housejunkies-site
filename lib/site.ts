...
export const site = {
  ...
  people: {
    ...
    projectManager: {
      ...
      bio: "Runs renovation and ADU projects for House Junkies Construction, the in-house licensed crew (CA LIC#1077593) that rehabs every property before resale and also takes on outside construction and ADU clients across Tulare, Kings, Kern, and Fresno counties. Reachable directly at (559) 350-1804.",
    },
  },
